...
<body>
    ...
    <div class="container">
                ...
                <div class="item active">
                    ...
                    <div class="carousel-caption">
                        <h1 style="font-family :'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">Dapatkan
                            Banyak Potongan Harga dari Kami</h1>
                    </div>
                </div>
        ...
        <br>
        <div class="jumbotron">
            <h1 style="color: rgb(47, 47, 54); text-shadow:  3px 3px 6px #9e9b95;"> <strong> <i> Jadikan Hunian <br>
                        Anda Lebih Nyaman <br> </i> </strong></h1>
        </div>
        <div class="judul">
            <h1 style="text-align:center; text-shadow:  3px 3px 6px #b49748; color: white"> <strong><i> Katalog Bulan
                        Ini </i></strong></h1>
        </div>
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="./gambar/kursi.jpg" width="200" height="200">
                    <div class="caption">
                        <h3 style="text-align:center"> <strong> <i> Kursi Goyang </i> </strong></h3>
