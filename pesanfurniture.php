...
<body>
    ...
    <ul class="nav nav-tabs" style="background-image: linear-gradient(120deg, #f6d365 0%, #fda085 100%);">
        <li role="presentation"><a href="customer.html" style="color: white;">Home</a></li>
        <li role="presentation"><a href="cus_profil.html" style="color:white">Profil </a></li>
        <li role="presentation"><a href="cus_pesanan.html" style=" text-decoration:none; color: rgb(46, 38, 38);font-family: segoe ui; font-size: 20px">
