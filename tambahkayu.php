    ...
    <div class="container" id="form">
        <div class="form-group" >
            <form class="bootstrap-form-with-validation" action="" method="post" enctype="multipart/form-data">
                <h2 class="text-center" style="color:white">Tambah Data Konten</h2>
                <div class="form-group">
                    <label class="control-label" for="identitas" style="color:white">Nama Kayu </label>
                    <input class="form-control" name="identitas" id="identitas" required="" type="text"></input>
                </div>
               <div class="form-group">
                    <label class="control-label" for="diameter" style="color:white">Diameter Kayu </label>
                    <input class="form-control" name="diameter" id="diameter" required=""  type="text"></input>
                </div>
               <div class="form-group">
                    <label class="control-label" for="panjang" style="color:white">Panjang Kayu </label>
                    <input class="form-control" name="panjang" id="panjang" required=""  type="text"></input>
                </div>
               <div class="form-group">
                    <label class="control-label" for="hargakayu" style="color:white">Harga Kayu </label>
                    <input class="form-control" name="hargakayu" id="hargakayu" required="" type="number"></input>
                </div>
               <div class="form-group">
                    <label class="control-label" for="stokkayu" style="color:white">Stok Kayu </label>
                    <input class="form-control" name="stokkayu" id="stokkayu" required=""  type="number"></input>
                </div>
                ...
                <div class="form-group">
                    <button class="btn btn-primary" type="submit" name="tambahkayu">Tambah</button>
                </div>
            </form>
        </div>
    </div>
