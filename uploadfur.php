...
$pembayaranfur = query("SELECT idtransaksi, pembayaranfurniture FROM transaksi WHERE idtransaksi = $idtransaksi")[0];


if (isset($_POST["pembayaranfur"])){
    
    
    if (pembayaran_fur( $_POST) > 0){
        echo "
        <script>
        ...
        <div class="row register-form" id="form">
            <div class="col-md-8 col-md-offset-2">
                <form class="form-horizontal custom-form" id="form" style="background:rgba(0,9,0,0.3)" action="" method="post" enctype="multipart/form-data">
                  ...
                  <input type="hidden" name="idtransaksi" value="<?= $pembayaranfur["idtransaksi"]; ?>">
                  <input type="hidden" name="gambarLama" value="<?= $pembayaranfur["pembayaranfurniture"]; ?>">
                <div class="form-group">
                       <!--  <div class="col-sm-4 label-column">
                        ...
                        <div class="col-sm-4 input-column">
                            <img src="gambarpembayaranfur/<?= $pembayaranfur['pembayaranfurniture'];  ?>" width="400px" height="300px"   >
                            <br>
                            <br>
                            <input class="form-control" type="file" name="pembayaranfurniture" id="pembayaranfurniture"  required="">
                        </div>
                    </div>
                  <br>

                    <button class="btn btn-primary" name="pembayaranfur" type="submit" style="border-radius:10px">Upload</button>
                </form>
            </div>
        </div>
    </div>
